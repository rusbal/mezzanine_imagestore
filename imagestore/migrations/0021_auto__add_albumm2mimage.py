...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlbumM2mImage'
        db.create_table('imagestore_album_m2m_image', (
        ...
        db.send_create_signal(u'imagestore', ['AlbumM2mImage'])
    ...
    def backwards(self, orm):
        # Deleting model 'AlbumM2mImage'
        db.delete_table('imagestore_album_m2m_image')
    ...
    models = {
        ...
        u'imagestore.albumm2mimage': {
            'Meta': {'object_name': 'AlbumM2mImage', 'db_table': "'imagestore_album_m2m_image'"},
        ...
        'imagestore.image': {
            ...
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'images'", 'symmetrical': 'False', 'through': u"orm['imagestore.AlbumM2mImage']", 'to': "orm['imagestore.Album']"}),
