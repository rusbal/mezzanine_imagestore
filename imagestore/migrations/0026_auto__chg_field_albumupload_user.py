...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlbumUpload.user'
        db.alter_column(u'imagestore_albumupload', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'AlbumUpload.user'
        db.alter_column(u'imagestore_albumupload', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
    ...
    models = {
        ...
        'imagestore.albumimage': {
            'Meta': {'ordering': "('order',)", 'object_name': 'AlbumImage', 'db_table': "'imagestore_album_images'"},
        ...
        'imagestore.image': {
            'Meta': {'ordering': "('title', 'id')", 'object_name': 'Image'},
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'images'", 'symmetrical': 'False', 'through': "orm['imagestore.AlbumImage']", 'to': "orm['imagestore.Album']"}),
