...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'imagestore.albumimages': {
            'Meta': {'object_name': 'AlbumImages', 'db_table': "'imagestore_album_images'"},
        ...
        'imagestore.image': {
            ...
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['imagestore.Album']", 'through': u"orm['imagestore.AlbumImages']", 'symmetrical': 'False'}),
