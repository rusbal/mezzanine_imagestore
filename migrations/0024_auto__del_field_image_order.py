...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'imagestore_image', 'order')


    def backwards(self, orm):
        # Adding field 'Image.order'
        db.add_column(u'imagestore_image', 'order',
    ...
    models = {
        ...
        'imagestore.image': {
            ...
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'images'", 'symmetrical': 'False', 'through': u"orm['imagestore.AlbumImage']", 'to': "orm['imagestore.Album']"}),
