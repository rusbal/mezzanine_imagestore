...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AlbumImage', fields ['album', 'image']
        db.create_unique('imagestore_album_images', ['album_id', 'image_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AlbumImage', fields ['album', 'image']
        db.delete_unique('imagestore_album_images', ['album_id', 'image_id'])
    ...
    models = {
        ...
        'imagestore.albumimage': {
            'Meta': {'ordering': "('order',)", 'unique_together': "(('album', 'image'),)", 'object_name': 'AlbumImage', 'db_table': "'imagestore_album_images'"},
