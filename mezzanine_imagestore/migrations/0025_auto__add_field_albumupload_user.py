...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumUpload.user'
        db.add_column(u'imagestore_albumupload', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumUpload.user'
        db.delete_column(u'imagestore_albumupload', 'user_id')
