...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imagestore_image', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['imagestore.Album']))

    def backwards(self, orm):

        # Changing field 'Image.album'
        db.alter_column(u'imagestore_image', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['imagestore.Album']))
    ...
    models = {
        ...
        'imagestore.image': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['imagestore.Album']"}),
